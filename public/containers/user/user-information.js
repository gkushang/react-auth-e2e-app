    ...
    render() {
        ...
        if(this.props.isFetchingUser) {
            return (
                <Paper className="container-fluid common" style={style} zDepth={1} rounded={true}>
                    <div className="container-fluid user-info-panel text-center user-fetching-circular">
                        <CircularProgress size={80} thickness={5} top={300} /> :
                    </div>
                </Paper>
            );
        }
        ...
        return (
            <Paper className="container-fluid common" style={style} zDepth={1} rounded={true}>
                ...
                {
                    this.props.isFetchingUser ? <CircularProgress size={80} thickness={5} top={300} /> :
                    <div>
